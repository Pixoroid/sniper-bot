...
def main():
    ...
    print(f"  Max SL: {MAX_SL} | Consecutive: {MAX_CONSECUTIVE_SL}")
    print(f" ATR SL Mult: {ATR_SL_MULT} | Trail Mult: {ATR_TRAIL_MULT}")
    print("="*45)
    ...
    while True:
        try:
            ...
            # Risk checks
            if sl_count >= MAX_SL:
                print(f" Max SL ({MAX_SL}) reached. 1hr wait...")
                time.sleep(3600)
                continue
